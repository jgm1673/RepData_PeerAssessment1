...
The mean total steps taken per day is `r av`
...
```
The 5-minute interval, on average across all the days in the dataset, which contains the maximum number of steps is `r max_int`
...
The mean total steps taken per day is `r t_av`
The median total number of steps taken per day is `r t_md`, so no difference for the mean and median, the differences appear in the 25% and 75% quantiles, above
